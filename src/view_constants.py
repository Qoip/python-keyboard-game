...
GRAPH_OFFSET = 50  # sides offset from the graph
HINT_FONT = "arial"  # font for hints on graph (hp, names)
HINT_FONT_SIZE = 15  # font size for hints

LEGEND_WIDTH = 200  # width of the legend
LEGEND_FONT = "jokerman"  # font for legend
LEGEND_FONT_SIZE = 30  # font size for legend
